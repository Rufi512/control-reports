                ...
                {equipments.length > 0 ? (
                  equipments.map((el: Equipment, i: number) => {
                    return (
                      <tr key={i}>
                        <th scope="row">
                          <Link to={`/equipment/detail/${el.id}`}>{el.asset_number.toUpperCase()}</Link>
                        </th>
                        <td>
                          <Link to={`/equipment/detail/${el.id}`}>{el.brand.toUpperCase()}</Link>
                        </td>
                        <td>
                          <Link to={`/equipment/detail/${el.id}`}>{el.model.toUpperCase()}</Link>
                        </td>
                        <td>
                          <Link to={`/equipment/detail/${el.id}`}>{el.serial.toUpperCase()}</Link>
                        </td>
                        <td>
